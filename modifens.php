...
$querymp="SELECT * FROM user WHERE user_id = '$ensId'";
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a  href="about_ens.php?userId=<?php echo $ensId; ?>">Espace Enseignant</a></li>
...
<div class="container">
  <form class="mt-4" method="POST" action="">
    ...
    <div>
    <input type="hidden" name="ensId" value="<?php echo $ensId; ?>">
    </div>
    <section></section>
...
// Récupérer le mot de passe actuel de l'utilisateur depuis la base de données
    ...
    if ($oldPassword === $realoldpassword) {
        ...
        $updateSql = "UPDATE user SET password = '$newPassword' WHERE user_id = '$ensId'";
