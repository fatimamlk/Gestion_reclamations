...
<html>
  ...
  <body>
    <div id="sidebar">
      <h2>Menu</h2>
      <ul>
        <li><a href="dashboard_ens.php">Mes reclamations</a></li>
        <li><a href="page_etudiant.php">À propos</a></li>
        <li><a href="traitementreclamation.php">traiter une reclamation</a></li>
      </ul>
    </div>
    <div id="content">
<!DOCTYPE html>
    ...
    <tr>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><a href="traitementreclamation.php?ID_Reclamation=<?php echo $ID_Reclamation; ?>">Traiter</a></td>
            </tr>
            <?php
        }
        ?>
